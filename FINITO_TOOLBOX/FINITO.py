...
################################################################################
# DESCRIÇÃO ALGORITMO:
# BIBLIO. DE USO COMUM PARA ALGORITMOS DE ELEMENTOS FINITOS DESENVOLVIDA PELO
...
def MEF2D(**kwargs):
    ...
    * Under development
    ...
    for I_ELEMENT in range(N_ELEMENTST3):
        ...
        K_G = K_G + K_GCONTRIBUITION
    if TYPE_SOLUTION == 1:
        K_G, FORCE_GLOBAL = FINITO_CL.ZERO_AND_ONE_METHOD(K_G, DOF_NODALFORCE, DOF_PRESCRIPTIONS, DOF_PRESCRIPTIONSVALUE)
        U_G = np.linalg.solve(K_G, FORCE_GLOBAL)
    RESULTS = U_G
    return RESULTS
